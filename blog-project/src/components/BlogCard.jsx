export const BlogCard = ({
  ...
  return (
    <div
      key={key}
      className=" border-[1px] w-[310px]  p-4 rounded-t-lg rounded-b-lg flex flex-col justify-center items-center gap-5"
    >
      <img
        className=" w-[260px] h-[185px] rounded-t-lg rounded-b-lg "
        src={img}
      />
