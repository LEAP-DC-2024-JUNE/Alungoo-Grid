...
export default function About() {
  return (
    <>
      <div className="xl:bg-gray-50  w-full text-center  bg-gray-50 dark:bg-gray-900 xl: px-20 xl:py-25">
        ...
        <div className="flex xl:flex-row xl:justify-between flex-col gap-5 p-10">
          <Image src={Pic2} />
          <div className=" flex flex-col gap-4 text-start">
            <p className=" font-extrabold text-3xl">
              Curious about me? Here you have it:
            </p>
            <div className="flex flex-col gap-4 xl:w-[1000px]">
